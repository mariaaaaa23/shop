                        ...
                        <table class="shop-cart-table">
                          ...
                          <tbody>
                            ...
                            $productQty = $item['quantity'];
                             @endphp
                            <tr class="cart_item">
                                <td class="item-img"><a href="#"><img src="{{ asset('storage/' . $product->image) }}" alt="Product tilte is here "> </a></td>
                          ...
                          <div class="col-md-4 col-sm-5 col-xs-12">
                            <div class="cart-total-area">
                              ...
                              <div class="sub-shipping">
                                <p> تومان <span>{{ $totalAmount }} </span></p>
                              ...
                              <div class="process-cart-total">
                                <p>قابل پرداخت <span>{{ $totalAmount }} تومان</span></p>
                              </div>
