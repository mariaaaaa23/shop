        ...
        <div class="row">
          ...
          <div class="col-md-8">
                  ...
                  <div class="card-body">
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <!-- /.direct-chat-info -->
                        <img class="/admin/direct-chat-img" src="dist/img/user1-128x128.jpg" alt="message user image">
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
            ...
            <div class="card">
              ...
              <div class="card-footer clearfix">
                <a href="/admin/javascript:void(0)" class="btn btn-sm btn-info float-left">سفارش جدید</a>
                <a href="/admin/javascript:void(0)" class="btn btn-sm btn-secondary float-right">مشاهده همه سفار</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
          ...
          <div class="col-md-4">
            ...
            <div class="card">
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="/admin/javascript:void(0)" class="product-title">تلویزیون سامسونگ
                  ...
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="/admin/javascript:void(0)" class="product-title">دوچرخه
                  ...
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="/admin/javascript:void(0)" class="product-title">پلی استیشن 4
              ...
              <!-- /.card-body -->
              <div class="card-footer text-center">
                <a href="/admin/javascript:void(0)" class="uppercase">نمایش همه محصولات</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
